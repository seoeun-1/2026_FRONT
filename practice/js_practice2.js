...
let 키 = Number(prompt("키(cm):"))
let 몸무게 = Number(prompt("몸무게(kg):"))
let BMI = 몸무게(kg) / (키(m) * 키(m))
console.log(`BMI : ${BMI}`)
//문제 5: 관리자 확인
...
let 마지막사람 = waitingList[waitingList.length - 1];
